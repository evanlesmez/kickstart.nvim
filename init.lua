...
vim.keymap.set('n', '<leader>pl', function() toggle_telescope(harpoon:list()) end, { desc = 'Open harpoon window' })
...
vim.keymap.set('n', '<leader>n%', function() neogit.open { cwd = '%:p:h' } end, { desc = 'Open neogit this file' })
